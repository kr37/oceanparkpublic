...
if (!$ppSuccess) {
    ...
    $_POST = ['mc_gross'=>'1.00', 'protection_eligibility'=>'Eligible', 'address_status'=>'confirmed', 'payer_id'=>'BLQC5USM2WX2N', 'address_street'=>'6556 24th Ave NW', 'payment_date'=>'11:00:53 May 29, 2021 PDT', 'payment_status'=>'Completed', 'charset'=>'windows-1252', 'address_zip'=>'98117', 'first_name'=>'Michael', 'mc_fee'=>'0.32', 'address_country_code'=>'US', 'address_name'=>'Michael Defever', 'notify_version'=>'3.9', 'custom'=>'Cart Code: 1', 'payer_status'=>'verified', 'business'=>'admin@meditateinolympia.org', 'address_country'=>'United States', 'address_city'=>'Seattle', 'quantity'=>'1', 'verify_sign'=>'A4WaYOCaviYl.24q4HSZpMk1SJKiAdqDpOXQ2oOZ1mr1eeSqcvB4Rd-k', 'payer_email'=>'kelsangrinzin@gmail.com', 'txn_id'=>'3KL42994YB621251T', 'payment_type'=>'instant', 'last_name'=>'Defever', 'address_state'=>'WA', 'receiver_email'=>'admin@meditateinolympia.org', 'payment_fee'=>'0.32', 'shipping_discount'=>'0.00', 'insurance_amount'=>'0.00', 'receiver_id'=>'GQPCQWGBS2GVY', 'txn_type'=>'web_accept', 'item_name'=>'Pathway to Bliss Weekend Retreat at Ocean Park', 'discount'=>'0.00', 'mc_currency'=>'USD', 'item_number'=>'', 'residence_country'=>'US', 'shipping_method'=>'Default', 'transaction_subject'=>'', 'payment_gross'=>'1.00', 'ipn_track_id'=>'45b9716f94ff1'];
    error_log("\n\nBEGINNING FAKE DATA\n\n".print_r($_POST,true)."\n", 3, ERRORLOG);
}
